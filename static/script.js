...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Replacing with Back end
    buildMarkerLayer("/cameradata", CameraMarkers, TrafficLightsIcon);
    buildMarkerLayer("/incidentdata", IncidentMarkers, IncidentIcon);
    // buildMarkerLayer(
    //     "https://data.calgary.ca/resource/k7p9-kppz.geojson",
    //     CameraMarkers,
    //     TrafficLightsIcon
    // );
    // buildMarkerLayer(
    //     "https://data.calgary.ca/resource/35ra-9556.geojson",
    //     IncidentMarkers,
    //     IncidentIcon
    // );
...
// ------- TEsting How to get data from backend
// fetch("/data")

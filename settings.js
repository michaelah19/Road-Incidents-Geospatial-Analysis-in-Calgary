...
const IncidentIcon = new BaseIcon({ iconSize: [25, 25], iconUrl: 'accidents.png' })
const TrafficLightsIcon = new BaseIcon({ iconSize: [20, 20], iconUrl: 'lights.png' })

// Map Initialization
darkgreyBase = L.tileLayer('https://api.mapbox.com/styles/v1/micdean19/ckm8ajpa120mr17qqdq7rnnvs/tiles/256/{z}/{x}/{y}@2x?access_token=pk.eyJ1IjoibWljZGVhbjE5IiwiYSI6ImNrbGhpeThrNzVmZTMycnBsdnFmYzF3NWMifQ.YBVdn03YJzG5mRWiSKqOkQ');
